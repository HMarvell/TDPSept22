...
Select GovernmentForm from Country Order By GovernmentForm DESC;
Select GovernmentForm, Count(GovernmentForm) From Country Group by GovernmentForm;

Select LifeExpectancy , Name From Country where (LifeExpectancy) is Not Null;

Select language, countrycode , Percentage From countrylanguage where (language) = "german";
